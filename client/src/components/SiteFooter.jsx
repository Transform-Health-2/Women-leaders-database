export default function SiteFooter() {
  return (
    <footer style={{ fontFamily: "'Montserrat', sans-serif" }}>
      ...
      <div style={{
        background: '#FEE5F6',
        backgroundImage: 'url(https://transformhealthcoalition.org/wp-content/themes/th/assets/images/footer_icon_bg.svg)',
        backgroundRepeat: 'no-repeat',
        backgroundSize: 'cover',
        backgroundPosition: 'center',
        padding: '50px 5vw',
      }}>
        <div style={{ maxWidth: '70%', margin: '0 auto', display: 'flex', gap: '40px', alignItems: 'flex-end' }}>
          {/* Left: links */}
          <div style={{ flex: 1 }}>
