...
function CheckItem({ checked, children }) {
  return (
    <li className="flex items-center gap-3 mb-2">
      <span className={`flex-shrink-0 w-5 h-5 rounded border-2 flex items-center justify-center text-[1.2rem] ${
        checked
    ...
    content: (
      <>
        ...
        <Ul>
          ...
          <Li>Magic links expire after 7 days — request a new one if expired</Li>
      ...
      <>
        ...
        <Ol start={3}>
          <Li>
            ...
            unique magic link (secure, valid for 7 days)
          </Li>
        </Ol>
        <Img
          src="screenshots/update-profile-email.png"
          caption="Update magic link email — leader receives a link to edit their profile (valid for 7 days)"
        />
        <Ol start={4}>
          <Li>
        ...
        <Ol start={3}>
          <Li>
            ...
            confirmation link (secure, valid for 7 days)
          </Li>
        </Ol>
        <Img
